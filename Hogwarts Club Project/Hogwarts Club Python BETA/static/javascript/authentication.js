// javascript file for authentication.html

// authentication method selection
let authenticationMethods = document.querySelectorAll(".authentication-method");
let authenticationForms = document.querySelectorAll(".authentication-form");
...
authenticationMethods.forEach((method) => {
    method.addEventListener("click", function () {
        ...
        document.querySelector(`#${method.id}-form`).classList.add("active-form");
    });
});
